...
//                  alert(JSON.stringify(this.pswObj.spassword))
...
// 			var gestureType = mnWebMain.syncGetLocalStorage(storageKey.GESTURE_TYPE);
 			
 			if (this.gestureType == gestureTypeKey.LOGIN_GESTURE)
 			{
 				gestureLoginController.gestureEndDeal(psw)
 				
 			}
 			else if (this.gestureType == gestureTypeKey.SET_GESTURE)
 			{
 				gestureSettingController.gestureEndDeal(psw);
 			}
 			else if (this.gestureType == gestureTypeKey.SALARY_VERTIFY_GESTURE)
 			{
 				myCommonController.gestureEndDeal(psw);
 			}
...
//          document.body.appendChild(wrap);
        ...
        H5lock.prototype.init = function() {
        	...
        	this.gestureType = mnWebMain.syncGetLocalStorage(storageKey.GESTURE_TYPE);
...
//          } : {};
            ...
            if (this.gestureType == gestureTypeKey.SALARY_VERTIFY_GESTURE)
            {
            	this.ctx.canvas.width = screen.availWidth * 0.88;
            }
            else
            {
            	this.ctx.canvas.width = screen.availWidth;
            }
